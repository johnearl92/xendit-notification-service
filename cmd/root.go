...
var rootCmd = &cobra.Command{
	Use:   "xendit-notification-service",
	Short: "xendit-notification-service exercise",
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.xendit-notification-service.yaml)")
}
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".xendit-notification-service")
	}
